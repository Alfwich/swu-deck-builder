...
import { getCardOwnershipStatus } from '../card-collection.js'
...
export function RightRail({ deck, ...collectionProps }) {
  return (
...
export function Card({ card, featured = false, flippable = false, onRemove = null }) {
...
export function DeckIdentities({ deck, onRemoveSecondLeader }) {
  return (
