...
import type { RemoteBackupHookState } from './use-remote-backup.js'

function statusMessage(
  status: RemoteBackupHookState['status'],
  ...
  return (
    ...
    >
      ...
      >
        ...
        {backup.status === 'conflict' && backup.conflict ? (
