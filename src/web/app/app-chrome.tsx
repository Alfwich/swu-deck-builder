...
import { cloudBackupButtonLabel } from '../player-database/backup/cloud-backup-presentation.js'
...
import type { CardFace } from '../types/catalog.js'
import type { RemoteBackupHookState } from '../player-database/backup/use-remote-backup.js'

export function CardCascade({ cardFaces }: { cardFaces: CardFace[] }) {
...
export function SiteNav({
  ...
  databaseImportInputRef: RefObject<HTMLInputElement | null>
  deckExportDisabledReason: string | null
  deckLibraryReady: boolean
  desktopSettingsAvailable: boolean
  remoteBackup: RemoteBackupHookState & { available: boolean }
  status: 'loading' | 'success' | 'error'
  tcgplayerAllDecks: boolean
  tcgplayerCopyDisabledReason: string | null
  tcgplayerMissingOnly: boolean
  topBarRef: RefObject<HTMLElement | null>
  onCloudBackupOpen(): void
  onCopySwudbDeck(): void
  onCopyTcgplayerDeck(): void
  onDatabaseExport(): void
  onDatabaseImport: ChangeEventHandler<HTMLInputElement>
  onDesktopSettingsOpen(): void
  onImportDeckOpen(): void
  onNewDeck(): void
  onTcgplayerAllDecksChange: Dispatch<SetStateAction<boolean>>
  onTcgplayerMissingOnlyChange: Dispatch<SetStateAction<boolean>>
}) {
  return (
