...
const iconSource = new URL('../src/assets/app-icon.png', import.meta.url)
const publicDirectory = new URL('../public/', import.meta.url)
const desktopDirectory = new URL('../desktop/assets/', import.meta.url)
...
console.log('Website and desktop icons generated from src/assets/app-icon.png.')
